...
% execute C Programm
[a unout]=unix(['/Users/caroline/Documents/MATLAB/MutualInformationEstimation/FinalFunctions_todistribute/kraskovStoegbauerGrassberger/MIxnyn zwspMIxnyn.txt ',num2str(Ndx),' ',num2str(Ndy),' ',num2str(N),' ',num2str(kneig)]);
miout=str2num(unout);
